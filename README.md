...
Navicat导入`LibrarySystem.sql`文件连接上本机数据库

后端项目名为 `LibraryNet`，用 IDEA 打开后，配置好 Maven 。
...
前端文件夹 `libraryNetView`，用 VScode 打开。

打开集成终端。

1. 先运行 `npm install` 命令，安装好相关依赖
2. 再运行 `npm run dev`
...
初始管理员账户：xiaojie/123456

初始读者用户：liqingzhao/123456
